...
public class NoteGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        while (noteInfo.rocket.Count > 0 && noteInfo.rocket[0].beat < songPositionBeats + beatsShownInAdvance)
        {
            ...
            rocketController.SpawnPos = new Vector3(rocket.transform.localPosition.x, 1.0f, rocket.transform.localPosition.z);
            rocketController.RemovePos = new Vector3(rocket.transform.localPosition.x, 1.0f, -1.5f);
