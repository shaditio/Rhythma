...
public class NoteGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject note = GameObject.Instantiate<GameObject>(noteTemplate);
        ...
        while (noteInfo.rocket.Count > 0 && noteInfo.rocket[0].beat < songPositionBeats + beatsShownInAdvance)
        {
            ...
            rocketController.SpawnPos = new Vector3(rocket.transform.localPosition.x, rocket.transform.localPosition.y + 1, rocket.transform.localPosition.z);
            rocketController.RemovePos = new Vector3(rocket.transform.localPosition.x, rocket.transform.localPosition.y + 1, -1.5f);
